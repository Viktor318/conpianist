...
### Új
- **Lejátszás más MIDI-eszközre, zongora nélkül (általános MIDI-eszköz mód).** A Kapcsolat beállításaiban a MIDI-kimenetek közül bármelyik választható (pl. loopMIDI-port egy szoftveres hangszerhez, például a Cantabile-hez). Ha a porton 3 másodpercen belül nem válaszol Yamaha zongora, a program általános MIDI-eszközként kezeli: nem küld Yamaha-specifikus üzeneteket, nem próbál újracsatlakozni, az állapotsorban a „MIDI-eszköz: <név>” felirat látszik, és a ConPianist saját lejátszója játssza a dalokat (az utolsó dal indításkor betöltődik). Működik a lejátszás minden funkciója, a szólamok és csatornák kapcsolása, a kotta és a virtuális billentyűzet. A Keverőben a hangerő, a pan és a zengetés szabványos MIDI-vezérlőkként (CC7, CC10, CC91) megy ki – a csatorna hangereje a dal saját hangerőváltozásait arányosan igazítja –, a Lejátszás panel hangereje minden csatornát arányosan állít, a „Hangszín módosítása” pedig a General MIDI hangszíneket (a 10. csatornán a dobkészleteket) kínálja, és a csatornák a GM-hangszín nevét mutatják. A zongorához kötött részek (Hangszín fül, Piano Room, Hangerőegyensúly, helyi vezérlés, Stream Lights, Segéd, zengetéstípus) ilyenkor szürkék. A loopMIDI által visszaküldött saját hangokat a program figyelmen kívül hagyja.
...
### Módosítva
- A Kapcsolat beállításaiban a „Zongora MIDI-portja” helyett „MIDI-port” szerepel, és a lista a MIDI-kimeneteket mutatja (a zongora portja is ezek között van). A program csak a kiválasztott porttal azonos nevű MIDI-bemenetet figyeli.
