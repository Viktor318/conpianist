...
Fő újdonságok: lejátszás MIDI-eszközre (pl. loopMIDI → Cantabile) zongora nélkül is, élő játék több csatornán a virtuális billentyűzettel és a MIDI In 2-vel, a lejátszott hangok a virtuális billentyűzeten.
...
### Módosítva
- **Kimenetek újraellenőrzése.** A Lejátszás rész fejlécében új **„Újra”** gomb: újra ellenőrzi a hálózati elérhetőséget, újranyitja a MIDI-eszközt (MIDI Out, MIDI In 2), és ha a zongora nincs csatlakozva, újracsatlakozik – a működő kapcsolatot nem bontja; így a kiszürkült választógombok kézzel újraaktiválhatók (pl. ha egy sikertelen feltöltés után a hálózati lejátszás szürke maradt). A Főmenü „Kapcsolat újraindítása” pontja most mindezt teljes újracsatlakozással végzi (korábban csak a zongora MIDI-kapcsolatát nyitotta újra).
