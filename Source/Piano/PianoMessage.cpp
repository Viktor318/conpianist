...
// Index: Channel(Main,Layer,Left); Value: 0 - Off, 1 - On
const Property Property::FixedCurve = Property("00 00 01 01", 1, 200);

// Value: 00..7f
const Property Property::FixedVelocity = Property("00 00 02 01", 1, 200);
